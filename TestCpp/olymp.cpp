...
int main()
{
	...
	// начальная точка
	// конечная точка
	// далее данные для каждой дороги:
	// начало, конец, расстояние

	//пример:
	// 7 10 (7 точек, 10 путей)
	// 1 7 (начальная точка - 1, конечная - 7)
	// 1 2 3 путь между точками 1 и 2 с расстоянием 3
	// 1 3 2 путь между точками 1 и 3 с расстоянием 2
	// 1 4 4 путь между точками 1 и 4 с расстоянием 4
	// 2 4 2 путь между точками 2 и 4 с расстоянием 2
	// 2 7 5 путь между точками 2 и 7 с расстоянием 5
	// 3 4 2 путь между точками 3 и 4 с расстоянием 2
	// 3 6 2 путь между точками 3 и 6 с расстоянием 2 
	// 4 5 2 путь между точками 4 и 5 с расстоянием 2
	// 5 6 2 путь между точками 5 и 6 с расстоянием 2
	// 5 7 2 путь между точками 5 и 7 с расстоянием 2

	//вывод будет выглядеть так:
	//8 [расстояние]
	//1 3 4 5 7 [оптимальный маршрут]
	...
	for (int i = 0; i < ShortestPaths.size(); i++)//вывод требуемых значений
	{
		if (ShortestPaths[i].size() == maxlength)
		{
			...
			for (int j = 1; j < ShortestPaths[i].size(); j++)
